...
public static class Caesar
{
    ...
    {
        var correctKeyBytes = Encoding.UTF8.GetBytes(pass);
        var cipherBytes = Encipher(correctKeyBytes, Encoding.UTF8.GetBytes(text));
    ...
    {
        var correctKeyBytes = Encoding.UTF8.GetBytes(pass);
        var plaintext = Encoding.UTF8.GetString(Decipher(correctKeyBytes, Convert.FromBase64String(cipherText)));
        return plaintext;
    }
